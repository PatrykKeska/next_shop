    ...
    <>
      <>
        ...
        >
          ...
          <div
            role='alert'
            className='rounded-xl sm: min-w-max border border-gray-100 bg-white p-4 shadow-xl fixed top-1/3 left-1/2 -translate-x-1/2 z-50'
          >
      ...
      >
        <div
          role='alert'
          className='sm: min-w-[300px] rounded border-s-4 border-red-500 bg-red-50 px-4 py-3 pb-6 shadow-xl fixed top-1/4 left-1/2 -translate-x-1/2 z-50'
        >
